...
class WardOfficials
{
    ...
    {
        if (Storage::disk('api')->exists('cronjob/ward-officials.json')) {
            DB::table('ward_officials')->truncate();
            $ward_officials = json_decode(file_get_contents(storage_path('app/cronjob' . DIRECTORY_SEPARATOR . 'ward-officials.json')), true);
